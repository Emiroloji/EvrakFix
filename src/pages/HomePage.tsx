import { 
  ...
  Key, Scan, Eraser, Briefcase, Scale, FolderOpen, CalendarDays, Languages, FileBadge 
} from 'lucide-react';
    ...
    <div className="flex flex-col gap-16 md:gap-24">
      ...
      <section className="relative flex flex-col items-center text-center gap-6 py-14 md:py-24 rounded-3xl overflow-hidden bg-slate-900 text-white px-6 md:px-12 shadow-xl shadow-slate-900/10">
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-2 mt-6 text-[11px] sm:text-xs text-slate-300/90 max-w-3xl z-10">
          ...
          <a href="/xml-invoice-viewer" className="px-2.5 py-1.5 rounded-xl bg-white/5 border border-white/10 hover:bg-white/15 hover:border-blue-500/40 hover:text-blue-300 transition-all font-semibold">📄 XML Fatura Göster</a>
